...
(function(){
    ...
    GLOBAL_OBJ.table.Events.UPDATE_TABLE_TING_RESULT          = "UPDATE_TABLE_TING_RESULT";            // 灯泡听牌提示消息

    GLOBAL_OBJ.table.Events.UPDATE_TABLE_CHONG_FENG           = "UPDATE_TABLE_CHONG_FENG";             // 收到独立冲锋鸡消息触发

    GLOBAL_OBJ.table.Events.UPDATE_TABLE_ASK_ABSENCE          = "UPDATE_TABLE_ASK_ABSENCE";            // 收到定缺消息触发
    GLOBAL_OBJ.table.Events.UPDATE_TABLE_ABSENCE_OWN          = "UPDATE_TABLE_ABSENCE_OWN";            // 收到自己定缺消息触发
    GLOBAL_OBJ.table.Events.UPDATE_TABLE_ABSENCE_END          = "UPDATE_TABLE_ABSENCE_END";            // 收到定缺结束消息触发
    GLOBAL_OBJ.table.Events.UPDATE_SHOW_ABSENCE_FIXD          = "UPDATE_SHOW_ABSENCE_FIXD";            // 显示定缺结束


    GLOBAL_OBJ.table.Events.DO_SHOW_HU_PREVIEW                = "DO_SHOW_HU_PREVIEW";                  // 查胡预览
