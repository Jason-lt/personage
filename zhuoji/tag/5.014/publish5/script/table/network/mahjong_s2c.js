	...
	GLOBAL_OBJ.table.network.S2C = {
		...
		boot:function() {
            ...
            */
            ...
            // 定缺
            this.MAPS[GLOBAL_OBJ.table.network.EventType.TABLE_ASK_ABSENCE]        = GLOBAL_OBJ.table.GameWorld.parseTableAskAbsence;
            this.MAPS[GLOBAL_OBJ.table.network.EventType.TABLE_ABSENCE_OWN]        = GLOBAL_OBJ.table.GameWorld.parseTableAbsenceOwn;
            this.MAPS[GLOBAL_OBJ.table.network.EventType.TABLE_ABSENCE_END]        = GLOBAL_OBJ.table.GameWorld.parseTableAbsenceEnd;
