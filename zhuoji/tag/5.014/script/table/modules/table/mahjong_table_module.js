        ...
        return {
            ...
            * */
            ...
            onRecvDiscard:function () {
                ...
                // // 出的牌是否是叫嘴的牌
                // if (view.tipPanel) {
                //     var huData = view.tipPanel.getHudata();
                //     //GLOBAL_OBJ.LOGD(this._TAG, "onRecv_Discard huData = " + JSON.stringify(huData));
                //     // 出的牌后能胡,显示灯牌提示
                //     if (huData[MODEL_DISCARD.getTile()] && sid == GLOBAL_T.MYSEAT) {
                //         view.tipNodeBtn.setVisible(true);
                //         var tingState = panel.getLocalTingState();
                //         if (tingState) {
                //             view.tipNodeBtn.setVisible(false);
                //         }
                //     }
                // }
            ...
            */
            ...
            doMethods:function(_model, _data, _isFromPlay) {
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "doMethods start; 111");
                var dataList = _data;
