...
(function(){
	...
	GLOBAL_OBJ.businesses.windows.VoiceTalking.Window = GLOBAL_OBJ.bkernel.base.BaseWindowController.extend({
		...
		initData:function(params_){
			...
			GLOBAL_OBJ.bkernel.utils.Notification.listen( GLOBAL_T.MAHJ_OWN_EVENTS.ON_DRAG, this.changeBtnState,this);
		...
		onCleanup:function(){
			...
			GLOBAL_OBJ.bkernel.utils.Notification.ignore( GLOBAL_T.MAHJ_OWN_EVENTS.ON_DRAG, this.changeBtnState,this);
		},
