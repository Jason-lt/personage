    ...
    */
    ...
    return PROTOTYPE.functionsExt(CACHE, {
        ...
        */
        ...
        // 获取豆分
        getDouScore:function(localSeatId){
            return CACHE[localSeatId].douScore || 0;
        },
        // 获取鸡分
        getJiScore:function(localSeatId){
            return CACHE[localSeatId].jiScore || 0;
        },

        // 获取胡分
        getWinScore:function(localSeatId){
            return CACHE[localSeatId].winScore || 0;
        },
