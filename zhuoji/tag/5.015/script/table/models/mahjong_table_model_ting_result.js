 ...
 * 协议说明：
...

 {
    ...
    "result":{
        "action":"updateTingResult",
        "gameId":720,"roomId":7201001001,"tableId":72010010010100,
        "seatId":0,
        "tingResult":[[21,1,3],[21,1,3],[21,1,3],[1,10,1],[2,10,1],[3,10,1],[4,10,3],[5,10,3],[7,10,3],[8,10,4]],
        "ishuAll":false }
    }
...
(function () {
    ...
    GLOBAL_OBJ.table.models.Ting_Result = (function () {
        ...
        var ___f_notificate = function (_object, _data, _slient) {
            ...
            if (!_slient) {
                GLOBAL_OBJ.bkernel.utils.Notification.trigger(GLOBAL_OBJ.table.Events.UPDATE_TABLE_TING_RESULT, CACHE.tingResult);
            };
            return _slient;
        };
