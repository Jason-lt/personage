...
(function(){
    ...
    GLOBAL_OBJ.Interface = hall.HallInterface.extend({
        ...
        mj_enterGameUI: function(){
            ...
            // 记录进入方式，roomlist, quickstart, ... -- Modify By Luwei
            ...
            if(getType == hall.Enums.GAMESLOT.QUICKSTART) {
                ...
                if (params && typeof(params.playMode) != 'undefined') {
                ...
                // GLOBAL_OBJ.LOGD(this._TAG, "enter mj by game: " + JSON.stringify(params));
