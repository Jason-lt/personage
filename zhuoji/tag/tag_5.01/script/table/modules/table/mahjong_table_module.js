...
(function(){
    ...
    var ____f_controller_producer = function( _name, _view ){
        ...
        var FUNCTION_DISCARD00 = function ( _mahj, _seatId, _isTing, discardModel) {
            ...
            GLOBAL_OBJ.LOGD(this._TAG, "pteShortenMahjsTeamByTile start; seatId:" + _seatId);
            ...
            GLOBAL_OBJ.LOGD(this._TAG, "pteShortenMahjsTeamByTile end; seatId:" + _seatId);
        };
        ...
        return {
            ...
            boot:function(){
                ...
                // 贵阳听牌消息
                this.doListen(MODEL_ASK_TING, E_TYPE.UPDATE_TABLE_ASK_TING, this.onRecvAskTing, this);
                this.doListen(MODEL_TING_STATE, E_TYPE.UPDATE_TABLE_TING_STATE, this.onRecvTingState, this);


                this.doListen(MODEL_CHONG_FENG, E_TYPE.UPDATE_TABLE_CHONG_FENG, this.onRecvChongFeng, this);
                ...
                GLOBAL_OBJ.bkernel.utils.Notification.listen(E_TYPE.UPDATE_TABLE_TING_END, function () {
            ...
            playGameBeginAnimation:function (_points) {
                var that = this;
                GLOBAL_OBJ.LOGD(this._TAG, "playGameBeginAnimation start;");
            ...
            playDealAni:function () {
                GLOBAL_OBJ.LOGD(this._TAG, "playDealAni start;");
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "playDealAni end;");
            },
            ...
            {
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvShowTaskTips start;");
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvShowTaskTips end;");
            },
            ...
            * */
            ...
            onRecvDiscard:function () {
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvDiscard end;");
            },
            ...
            onRecvAskTing:function () {
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvAskTing......start.....");

                this.doMethods(MODEL_ASK_TING, MODEL_ASK_TING.getMethods());

                GLOBAL_OBJ.LOGD(this._TAG, "onRecvAskTing......end.....");
            },
            ...
            onRecvAskCharge:function () { // 弹 出充值界面
            ...
            onRecvWinLose:function() {
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvWinLose start;");
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvWinLose lsid = " + lsid);
                if(fake == true) {
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "onRecvWinLose end;");
            },
            ...
            playZaPaiAni:function (winSeatId) {
                ...
                GLOBAL_OBJ.LOGD(this._TAG, "playZaPaiAni winSeatId = " + JSON.stringify(winSeatId));
                GLOBAL_OBJ.LOGD(this._TAG, "playZaPaiAni winTiles = " + JSON.stringify(winTiles));
            ...
            countWinLoseMessage:function () {
                ...
                GLOBAL_OBJ.LOGD(this._TAG,"countWinLoseMessage receive_budgets_count = " + receive_budgets_count);
                if (receive_budgets_count < 4) {
                    return;
                }
            ...
            drawJi:function(_tileId){
                ...
                var fCenter = cc.p(0, 58);
                var tileId = _tileId;
                fanpaiji.scheduleOnce(function () {
                    GLOBAL_OBJ.bkernel.utils.Animation.play(
                        fanpaiji,
                        GLOBAL_OBJ.RES.MJ_ZM_KAIMA2_CCBI,
                        fCenter,
                        function(_ani){
                            var res = GLOBAL_OBJ.GAMENAME.toUpperCase() + "_"+tileId+"_PNG";
                            //this.setTextureByName(this.patternSpr, GLOBAL_OBJ.RES[res]);
                            GLOBAL_FUNCS.textureChange(_ani['maTile'],GLOBAL_OBJ.RES[res]);
                        },
                        function(_ani){
                            GLOBAL_OBJ.bkernel.utils.Animation.play(
                                fanpaiji,
                                GLOBAL_OBJ.RES.MJ_ZM_KAIMA3_CCBI,
                                fCenter,
                                function(ani){},
                                function(ani){
                                    var fanpaiji_show = new GLOBAL_OBJ.table.windows.gymj.result.Budgets.FanPaiJi();
                                    fanpaiji_show.getRootNode().setPosition(cc.p(0,0));
                                    fanpaiji_show.getRootNode().setAnchorPoint(cc.p(0.5,0.5));
                                    fanpaiji.addChild(fanpaiji_show.getRootNode(),-1);
                                    fanpaiji.scheduleOnce(function () {
                                        that.showBudgetGY();
            ...
            */
            ...
            doTingPreview:function (_model) {
                ...
                var type = _model.getTingType() || 2;
                GLOBAL_OBJ.LOGD(this._TAG, "___do__Ting_Preview_ting_type = ", type);
                if (type == 1) {
                    // 硬听
