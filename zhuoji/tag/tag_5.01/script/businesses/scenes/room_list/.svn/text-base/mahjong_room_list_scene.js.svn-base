...
(function(){
	...
	GLOBAL_OBJ.businesses.scenes.RoomList.Scene = GLOBAL_OBJ.bkernel.base.BaseSceneController.extend({
		...
		onLoad: function() {
            ...
            // this._sceneCtr.setRoomTitle(GLOBAL_OBJ.RES.MAHJ_ROOM_TITLE_ZYZ_PNG);
            this._sceneCtr.setRoomTitle(GLOBAL_OBJ.RES.MAHJ_ROOM_TITLE_1_PNG);
        ...
        showBestRoom:function () {
            ...
            var c = MODEL.getRoomCount(this.playMode);
