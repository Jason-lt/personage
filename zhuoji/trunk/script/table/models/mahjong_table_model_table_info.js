...
guiyang.table.models.TableInfo = (function(){
    ...
    */
    ...
    PROTOTYPE.setPrivateProperty(CACHE, "chongFengJi", -1, "冲锋鸡玩家seatId");
    PROTOTYPE.setPrivateProperty(CACHE, "zeRenJi", -1, "责任鸡玩家seatId");

    PROTOTYPE.setPrivateProperty(CACHE, "isShowSameIP", 0, "是否显示同ip下提示");
    ...
    var ___f_notificate = function(_object, _data, _slient){
        ...
        CACHE.chongFengJi            = data.chongFengJi;
        CACHE.zeRenJi                = data.zeRenJi;

        CACHE.isShowSameIP           = data.isShowSameIP;
    ...
    return PROTOTYPE.functionsExt(CACHE, {
        ...
        */
        ...
        parse:function(_data, _slient){
            var data = _data;
            //GLOBAL_OBJ.LOGD("mahjong_table_model_info.js", "model_info parse data = " + JSON.stringify(data));
            if (!data){
                return;  
            }
        ...
        */ 
        ...
        getShowSameIP:function () {
            return CACHE.isShowSameIP || 0;  
        },
        ...
        /*
        获取冲锋鸡玩家seatid*/
        getChongFengJiId:function(){
            if (CACHE.chongFengJi >= 0)
            {
                return GLOBAL_OBJ.table.utils.Seat.toLocalSeatId(CACHE.chongFengJi);
            }else {
                return -1;
            }
        },
        ...
        /*
         获取责任鸡玩家seatid*/
        getZerenJiId:function(){
            if (CACHE.zeRenJi >= 0)
            {
                return GLOBAL_OBJ.table.utils.Seat.toLocalSeatId(CACHE.zeRenJi);
            }else {
                return -1;
            }
