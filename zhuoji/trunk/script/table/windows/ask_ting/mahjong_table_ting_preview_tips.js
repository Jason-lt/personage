...
(function(){
	...
	GLOBAL_OBJ.table.windows.TingPreview.Tips = GLOBAL_OBJ.bkernel.base.BaseWindowController.extend({
		...
		updatePos:function(_slotPositon) {
			var size = cc.director.getWinSize();
			var offy = size.height/4;
			this.getRootNode().setPosition( cc.p(0, _slotPositon - offy) )
		},
		...
		update:function(_data, _huAll) {
			...
			// GLOBAL_OBJ.LOGD(this._TAG, "查胡提示  update = " + JSON.stringify(_data));
