...
(function(){
	...
	GLOBAL_OBJ.businesses.network.S2C = {
		...
		boot:function() {
            ...
            // 牌桌相关cmd处理函数
            this.MAPS[GLOBAL_OBJ.businesses.network.EventType.GAME]                     = GLOBAL_OBJ.businesses.GameWorld.parseGame;
            ...
            */
            ...
            this.MAPS[GLOBAL_OBJ.businesses.network.EventType.ROOM]                     = GLOBAL_OBJ.businesses.GameWorld.parseRoom;
            this.MAPS[GLOBAL_OBJ.businesses.network.EventType.MATCH]                    = GLOBAL_OBJ.businesses.GameWorld.parseMatch;
