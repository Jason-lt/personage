...
(function(){
	...
	GLOBAL_OBJ.businesses.scenes.RoomList.pageTagItem = cc.Class.extend({
		ctor: function(tagId) {
	...
	GLOBAL_OBJ.businesses.scenes.RoomList.pageTag = cc.Class.extend({
		...
		_createNode: function(cnt) {
			...
			var totalW = 0;
			for (var i=0; i<cnt; i++) {
				var itemNode = new GLOBAL_OBJ.businesses.roomList.pageTagItem(i);
